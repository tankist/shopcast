...
class Skaya_Auth_Adapter_Doctrine2 implements Zend_Auth_Adapter_Interface
{
    /**
    ...
    /**
     * $_saltColumn - column to be used as salt
     *
     * @var string
     */
     ...
     * @var Closure
     */
    protected $_credentialMutator = null;
    ...
    {
        $this->_credentialMutator = $credentialMutator;
        return $this;
    }
