...
class Backend_ProductsController extends Zend_Controller_Action
{
    ...
    {
        $this->view->submenu = '<a href="/store/products/add">Add Product</a>';
    ...
    public function addAction()
    {
        ...
        foreach ($this->_store->getCategories() as /** @var Model_Category **/
                 $category) {
            $storeCategories[$category->id] = $category->name;
        }

        $form = new Store_Form_Product(array(
            'name' => 'product',
            'action' => '/store/products/save',
        ...
        $productImageForm = new Store_Form_ProductImage(array(
            'name' => 'productImage',
            'action' => '/store/products/add-product-image',
            'imagesPath' => ''
        ));
    ...
    public function editAction()
    {
        ...
        if ($product_id = (int)$request->getParam('id')) {
            ...
            foreach ($product->getOptions() as /** @var Model_Option **/
                     $option) {
    ...
    public function saveAction()
    {
        ...
        if ($request->isPost() && $form->isValid($request->getPost())) {
            ...
            if ($product instanceof Model_Product) {
                $this->_redirect('/store/products/edit/id/' . $product->id . '/');
            } else {
                $this->_redirect('/store/products/add/');
            }
        }
    }
    ...
    public function addProductImageAction()
    {
        ...
        $form = new Store_Form_ProductImage(array(
            'name' => 'productImage',
            'action' => '/store/products/add-product-image',
    ...
    public function listAction()
    {
        ...
        foreach ($products as /** @var Model_Product **/
                 $product) {
            $productBlob = array(
                'product_id' => $product->id,
