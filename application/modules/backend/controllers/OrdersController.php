...
class Backend_OrdersController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $orderShippingForm = new Store_Form_OrderShipping(array(
            'name' => 'orderShipping',
            'action' => '/store/orders/confirm-shipment',
    ...
    public function convertAction()
    {
        ...
        foreach ($storesIds as $_row) {
            try {
                ...
                foreach ($orders as /** @var Model_Order **/
                         $order) {
