...
class Backend_ProfileController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $profileForm = new Store_Form_StoreProfile(array(
            'name' => 'profile',
            'action' => '/store/store/save-profile',
        ...
        $profileImageForm = new Store_Form_ProfileImage(array(
            'name' => 'profileImage',
            'action' => '/store/store/add-image',
            'imagesPath' => ''
        ));
    ...
    public function saveAction()
    {
        ...
        if ($request->isPost() && $profileForm->isValid($request->getPost())) {
            ...
            $this->_redirect('/store/store/edit');
            ...
            if (!$store_id) {
                $this->_redirect('/store/store/add');
            } else {
                $this->_redirect('/store/store/edit');
            }
        }
    ...
    public function imageAction()
    {
        ...
        $profileForm = new Store_Form_ProfileImage(array(
            'name' => 'profileImage',
            'action' => '/store/store/add-image',
