<?php
class Store_Form_DesignLayout extends Zend_Form {
	...
	public function init() {
		$storeElementsForm = new Store_Form_DesignStoreElements($this->_getFormOptions('DesignStoreElements'));
		$structureForm = new Store_Form_DesignStructure($this->_getFormOptions('DesignStructure'));
		$embedForm = new Store_Form_DesignEmbedSettings($this->_getFormOptions('DesignEmbedSettings'));
